...
var app = (function () {
    ...
    /* src\ContentCard.svelte generated by Svelte v3.58.0 */

    const file$1 = "src\\ContentCard.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "header svelte-1xfqfw3");
    			toggle_class(h1, "header-alt", /*shouldHighlight*/ ctx[1]);
    			add_location(h1, file$1, 6, 0, 191);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (courseGoal === undefined && !('courseGoal' in $$props || $$self.$$.bound[$$self.$$.props['courseGoal']])) {
    			console.warn("<ContentCard> was created without expected prop 'courseGoal'");
    		}
    	});
    	...
    	$$self.$capture_state = () => ({ courseGoal, shouldHighlight });

    	$$self.$inject_state = $$props => {
    		if ('courseGoal' in $$props) $$invalidate(0, courseGoal = $$props.courseGoal);
    		if ('shouldHighlight' in $$props) $$invalidate(1, shouldHighlight = $$props.shouldHighlight);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*courseGoal*/ 1) {
    			$$invalidate(1, shouldHighlight = courseGoal.includes('!'));
    		}
    	};

    	return [courseGoal, shouldHighlight];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 7, 0, 101);
    			add_location(p, file, 9, 0, 122);
    			add_location(li0, file, 12, 2, 156);
    			add_location(li1, file, 13, 2, 228);
    			add_location(li2, file, 14, 2, 274);
    			add_location(li3, file, 17, 2, 385);
    			add_location(ol, file, 11, 0, 149);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 22, 0, 492);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*goal*/ 1) contentcard_changes.courseGoal = /*goal*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ContentCard, goal });
