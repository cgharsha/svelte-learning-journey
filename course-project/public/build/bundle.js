...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-11arh0"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$5, 10, 2, 188);
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mode*/ 8 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-11arh0"))) {
    ...
    function create_fragment$4(ctx) {
    	...
    	button2.$on("click", /*click_handler*/ ctx[8]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 17, 4, 353);
    			attr_dev(h2, "class", "svelte-enhpap");
    			add_location(h2, file$4, 18, 4, 375);
    			attr_dev(p0, "class", "svelte-enhpap");
    			add_location(p0, file$4, 19, 4, 400);
    			attr_dev(header, "class", "svelte-enhpap");
    			add_location(header, file$4, 16, 2, 339);
    			...
    			add_location(img, file$4, 22, 4, 458);
    			attr_dev(div0, "class", "image svelte-enhpap");
    			add_location(div0, file$4, 21, 2, 433);
    			attr_dev(p1, "class", "svelte-enhpap");
    			add_location(p1, file$4, 25, 4, 533);
    			attr_dev(div1, "class", "content svelte-enhpap");
    			add_location(div1, file$4, 24, 2, 506);
    			attr_dev(footer, "class", "svelte-enhpap");
    			add_location(footer, file$4, 27, 2, 567);
    			attr_dev(article, "class", "svelte-enhpap");
    			add_location(article, file$4, 15, 0, 326);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['id', 'title', 'subtitle', 'imageUrl', 'description', 'address', 'email'];
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 22, 4, 436);
    			attr_dev(header, "class", "svelte-ivbrrj");
    			add_location(header, file$2, 21, 0, 422);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 12, 4, 273);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 10, 2, 200);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-1cfh25e");
    			add_location(form, file, 102, 4, 3219);
    			attr_dev(main, "class", "svelte-1cfh25e");
    			add_location(main, file, 101, 0, 3208);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
